...
var template = Handlebars.compile(
  fs.readFileSync(config.RC_DEMO_FAX_COVERPAGE_TEMPLATE, "utf8")
);
...
// pdf.create(html, options).toFile("./coverletter.pdf", function (err, res) {
//   if (err) return console.log(err);
//   console.log(res);
//   formData.append("attachment", fs.createReadStream("./coverletter.pdf"), {
...
// formData.append(
//   "attachment",
//   fs.createReadStream(config.RC_DEMO_FAX_FILEPATH),
